...
"),
  ...
  p(""),
  h2("Conclusion"),
  p("As said before, Netflix is an American streaming service that offers a variety of movies, TV shows, anime, documentaries and much more. And for this project, we wanted to focus on the distribution of popular Netflix streams and how that would look across the World. This was something we wanted to focus on because everyday, there are so many new streams and new films being produced that we lose track of what’s popular and what’s not. For this project, we created three interactive features that were able to show Netflix content distributed by country, Top 10 IMDb rated content on Netflix, and also the distribution of Netflix shows and their TV/IMDb rating scores between 2018 and 2022. We found out that for Netflix content the most popular countries were the United States, India, and also the United Kingdom. We made this chart so that you can filter different genres and look at the top rated productions. For our last interactive, the purpose was so that you can scroll through the years and see the change in rating distribution of Netflix shows overall. By creating these three interactive features, we were able to understand more of  Netflix’s distributions and how they compare and contrast to each other. 
"),
  h2("References"),
  p("")
)
