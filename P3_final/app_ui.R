...
report_panel <-tabPanel(
 "Report",
  ...
  p("Autumn 2023"),
  h2("Abstract"),
  p("Our main question is"), 
    p(em("What are the most popular show in all of the states across the U.S?")), 
 p("We hope to find different correlations between the shows rating and its popularity. To address these questions we plan on using netflix csv files from the internet and performing analysis on it. We will be using different ggplot graphs and other data wrangling techniques to answer any questions we have."),
  h2("Affiliation"),
  ...
  a(href = "", "https://www.kaggle.com/datasets/shivamb/netflix-shows?datasetId=434238"),
  h2("Problem Domains"),
...
"),
  ...
  p("“What is the most popular show in each state in the U.S?”"),
  
  p("This is our main question that we wanted to research about and we were curious on how it is compared across the country."),
  
  p("How do different shows ratings across the five regions (Northeast, Southwest, West, Southeast, and Midwest) compare to each other? Are there similarities or differences?
  ...
  p("We also want to see the popularity of shows in different reasons. (are india based films more popular in south asia, etc..)"),

  p("Researching about the most watched Netflix show in state, about how many hours was viewed on that show?"),
  
  p("We are also curious about how many hours is spent on each show, it can tell us how much a state likes that show compared to any other place/region."),

  p("The quality of shows and movies that Netflix is a topic we are interested in."),
  
  p("Is the quality of the shows that Netflix put out good? Based on user scores should I keep my Netflix subscription or switch to another streaming platform?"),

  p("Does Netflix distribute more shows or movies?"),
...
"),
  ...
  h2("Discussion"),
  p("By organizing our data into visuals that depicted popular shows over time and popular shows over different countries, we can see how social interests change over time. We can see the most popular shows over the years include Bird Box, The Queen’s Gambit, and Squid Game, all of which are very creative shows that won awards. This shows how people seek entertainment that challenge their way of seeing the world. It’s important to see how societies interests change over time when looking at show ratings because this can indicate how people can become more open minded to watching a variety of films. When people become more open minded, they can be more willing to watch shows that are international, have a diverse acting crew, and learn more about different perspectives of life overall. 
After reviewing our data, we also noticed some implications. As seen in our map, the United States, India, and United Kingdom were the top countries with the most content on Netflix. This gives us the implications that there are high amounts of film production which indicate high levels of creativity and diverse film genres. Most importantly, the U.S is known for award winning Hollywood films while India is known for their Bollywood films. Not only does watching new shows increase your learning, but it also improves the economy. The more people that are watching shows, the more money the producers and streaming platforms earn. In the U.S, Netflix made about $12.97 billion dollars in revenue in 2021 (Basuroy). In India, the film industry, Bollywood generated 139 billion rupees which is about $1.7 billion USD (“Home App Data Netflix Revenue and Usage Statistics (2022)”). Furthermore, Netflix has their own catalogue of movies and T.V shows based on the country which allow people such as in India to stream Bollywood films. People in different countries are able to watch films that were made in their country through Netflix including Netflix originals made in the U.S. 
"),
  h2("Conclusion"),
  p("As said before, Netflix is an American streaming service that offers a variety of movies, TV shows, anime, documentaries and much more and for this project, we wanted to focus on the distribution of popular Netflix streams and how that would look like across the World. This was something we wanted to focus on because everyday, there are so many new streams and new films being produced that we lose track of what is popular and what is not. For this project, we were able to create three interactive features that were able to show Netflix content distributed by country, Top 10 IMDb rated content on Netflix, and also the distribution of Netflix shows as well as their TV/IMDb rating scores between 2018 and 2022. We found out that for Netflix content, the most popular countries were the United States, India, and also the United Kingdom. We can infer that these countries had the most popularity because for example, the United States has great media marketing which is able to distribute/market around the world. Also, the Hollywood film industry is a huge industry that is able to boost streams for the United States. We made this chart so that you can filter different genres and look at the top rated productions. For our last interactive, the purpose was so that you can scroll through the years and see the change in rating distribution of Netflix shows overall. By creating these three interactive features, we were able to understand more of  Netflix’s distributions and how they compare and contrast to each other. 

"),
  h2("References"),
  p("Basuroy, Tanushree. “India: box office revenue 2022.” Statista, 28 October 2022, https://www.statista.com/statistics/316810/india-box-office-revenue/. Accessed 7 December 2022."),

p("Countries where Netflix is available. (n.d.). Netflix Help Center. Retrieved October 31, 2022, from https://help.netflix.com/en/node/14164"),

p("Home App Data Netflix Revenue and Usage Statistics (2022).” Business of Apps, 27 October 2022, https://www.businessofapps.com/data/netflix-statistics/. Accessed 7 December 2022."),

p ("Matrix, S., & Anya, M. (2014). The Netflix Effect: Teens, Binge Watching, and On-Demand Digital Media Trends. UTP Journals. Retrieved October 31, 2022, from https://www.utpjournals.press/doi/abs/10.3138/jeunesse.6.1.119
"),
p("SLA Alumni. (2018, January 30). Netflix: The Media Killer - Digital Innovation and Transformation. HBS Digital Initiative. Retrieved October 31, 2022, from https://d3.harvard.edu/platform-digit/submission/netflix-the-media-killer/")
)
